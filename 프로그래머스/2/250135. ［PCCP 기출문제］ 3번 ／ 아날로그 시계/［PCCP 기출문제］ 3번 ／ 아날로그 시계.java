...
class Solution {
    ...
    static int cal(int time){
        int sm = time*59/3600; //분침이 한 바퀴 도는데 초침이랑 59번 겹친다
        ...
        int sh = time*719/43200; // 시침이 한바퀴 돌 때 초침과의 만남.
                                 // 위와 마찬가지로 시침이 한 바퀴 도는데는 43200초다.
...
힌트 1 : 각도이용
힌트 2 : 0:0:0 ~23:59:59
힌트 3 : 1분당 초침과 시&분침 만남 2회. 1시간당 60*2 (시침과 초침은 h*60번, 분침과 초침은 59회_아래에서 처리)
힌트 4 : 59분 -> 00분 : 초침과 분침 만남 x. => 시간당 -1
특수경우 1 : 0시0분0초 , 12시0분0초는 시-분-초 침이 만나서 카운트를 하나 
특수경우 2 : 11시59분 -> 12시 & 23시59분 -> 00시 : 시침과 초침 x => -1씩
*/