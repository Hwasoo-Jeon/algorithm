...
### 참고사항
 <p>N은 최대 500,000 각자리 모두 0~9까지 재귀 돌려도 10^6</p>
 <p>정규표현식: matches("[0]+") => + 는 모든 자리 수</p>
 <p>반례ex) 9999면 999부터 99999 자리까지 탐색해야함.</p>
